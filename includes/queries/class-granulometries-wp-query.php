<?php
class Granulometries_WP_Query extends WP_Query{
	...
	public function posts_fields( $sql, $q ){
		global $wpdb;
		return " COUNT(*) as n, TRUNCATE( AVG( meta.meta_value ), 2 ) avg_ys, icas_terms.name as tax_name, icas_terms.term_id as term_id ";
	}
	...
	public function posts_where( $sql, $q ){
		...
		$sql .= " AND icas_term_tax.taxonomy = 'trans_gal_type' ";
		return $sql;
	}
